<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="solditem.aspx.cs" Inherits="project_demo.solditem" %>
...
<body>
	...
	<div>
		...
		<asp:HyperLink ID="HyperLink9" runat="server" NavigateUrl="~/userdetails.aspx"> User Details </asp:HyperLink>
         ...
         <br/><br/><br />
        <br />
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Larger" Text="Items Sold"></asp:Label>
        <br />
        <br />
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:storeConnectionString %>" SelectCommand="SELECT * FROM [solditems] WHERE ([status] NOT LIKE '%' + @status + '%')" UpdateCommand="UPDATE [solditems] SET [status]=@status WHERE([Id]=@Id)">
            <SelectParameters>
                <asp:Parameter DefaultValue="delivered" Name="status" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None"  Height="119px" OnRowUpdating="Gridview_update" Width="396px">
                ...
                <asp:TemplateField HeaderText="status" SortExpression="status">
                   ...
                   <asp:DropDownList ID="DropDownList2" runat="server" SelectedValue='<%# Bind("status") %>'>
                       <asp:ListItem>waiting for confirmation</asp:ListItem>
                        <asp:ListItem>order confirmed</asp:ListItem>
                        <asp:ListItem>order dispatched</asp:ListItem>
                        <asp:ListItem>order shopped</asp:ListItem>
